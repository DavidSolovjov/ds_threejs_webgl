...
import { FaMailBulk, FaSkype, FaGithub, FaDiscord, FaTelegram, FaLinkedin, FaYoutube } from 'react-icons/fa';
  ...
  componentDidMount(){        
    ...
    function particles() {
      ...
      material = new THREE.ShaderMaterial({
        uniforms: THREE.UniformsUtils.clone({
          ...
          time: { type: "f", value: 0 }, 
          color: { type: "c", value: new THREE.Color(0xaa88dd) },
    ...
    function init() {
      ...
      for (var i = 0; i < nbTrucs; i++) {
        ...
        var material = new THREE.MeshStandardMaterial({ color: 0xffaaff, roughness: 0.3, metalness: 0.9 });      
      ...
      <>
          ...
          <div className='w-full h-[100vh] '>
            <div className='w-full md:w-[60%] h-full text-white font-medium flex justify-center items-center'>
              <div>
                {/* <div className='text-32 md:text-45 py-8 text-center md:text-left'>DSv</div> */}
                <div className='text-lg md:text-36 pb-8 text-center md:text-left'>Full stack Developer<br/>In Blockchain , Web, Mobile Development</div>
                <div className='text-36 p-8 text-center'>                  
                  ...
                  <div className='text-white text-xl md:text-45 font-medium mt-2 flex justify-between items-center'>
                    ...
                    <Link href={'https://www.youtube.com/channel/UC3B9g2Cp1jI5X0mcB5oJbZw'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaYoutube/>
                      </a>
                    </Link>
                    <Link href={'https://www.linkedin.com/in/david-solovjov-b2b651212/'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaLinkedin/>
                      </a>
                    </Link>
