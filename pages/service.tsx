            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='w-full h-full flex items-center justify-center md:pr-24'>
                <div className='text-white text-sm md:text-lg font-medium'>
                  ...
                  <div className='my-1'>- Solidity , Rust, Smartcontracts, DEFI, Dex, Web3, Marketplace</div>                                    
                  <div className='my-1'>- WebGL, Three.js, Canvas, SVG, Unity, GSAP, GLSL</div>
                  ...
                  <div className='my-1'>- GIS , Lidar , Ceisum , Resium , MapboxGL , DarkGL</div>                            
